  ...
  return (
    <div className="mx-5 shadow-sm border-b bg-white sticky top-0">
      <div className="flex justify-between max-w-screen-xl lg:mx-auto">
        <div onClick={() => router.push("/")} className="relative w-24 cursor-pointer">
          <Image
          ...
          {session ? (
            <>
             ...
             text-white"
              ...
              <PlusCircleIcon onClick={setModal} className=" navBtn" />
              <UserGroupIcon className="navBtn" />
              <HeartIcon className=" navBtn " />
              <img
              onClick={signOut}
                className=" relative h-8 w-8  rounded-full hover:scale-110 hover:cursor-pointer"
